  ...
  return (
    <div className="bg-[#000000] flex justify-center items-center h-screen">
      <div className="w-full max-w-xl text-white flex flex-col items-center">
        ...
        <h1 className="text-3xl font-bold mb-4">Welcome to PeGo</h1>
        
        <p className="text-xl mb-2">The game is on the <Link href="/clicker" className="underline">Clicker</Link> page.</p>
        <p className="text-xl mb-6">Developed by <Link href="https://www.youtube.com/@PeGo" target="_blank" className="underline">PeGoverse</Link>.</p>
